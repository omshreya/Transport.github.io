				...
				<div class="col">
					<div class="home_search_container">
						...
						<div class="home_search_content">
							<form action="addFacility" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
									<input type="checkbox" name="Food" value="100">Food Facility
									<span></span>
									<span></span>
									<input type="checkbox" name="Stay" value="200">Stay Facility
